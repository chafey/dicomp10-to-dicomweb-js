...
const {
  StudyDescription, AccessionNumber, StudyInstanceUID, StudyDate, StudyTime,
} = Tags;
const {
  SeriesDescription, SeriesNumber, SeriesInstanceUID, SeriesDate, SeriesTime,
} = Tags;

const {
  DeduppedCreator, DeduppedTag, DeduppedHash, DeduppedRef, DeduppedType,
} = Tags;
